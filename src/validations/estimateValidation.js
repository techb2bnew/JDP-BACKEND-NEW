...
export const createEstimateSchema = Joi.object({
  ...
  bill_to_address: Joi.string().allow('').optional(),
  billing_to_address: Joi.string().allow('').optional(),
  ...
  custom_products: Joi.array().items(
    Joi.object({
      ...
      supplier_sku: Joi.string().max(100).allow('').optional(),
      jdp_sku: Joi.string().max(100).allow('').optional(),
